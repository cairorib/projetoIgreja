...
<div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Update form MIDIAS</h3>
              </div>
              <!-- /.card-header --> 
              <!-- form start -->
               ...
               <?php  endif ?> 
                <div class="card-body">
                    <?php echo form_open('MidiasControl/update'); ?> 
                    ...
                    <div class="form-group row">
                      <label for="inputPassword3" class="col-sm-2 col-form-label">Testemunho</label>
                      <div class="col-sm-10">
                        <input class='form-control' name='url' value="<?= $dados['data'] ?>"  placeholder='Descrição do testemunho'/>  
                        <?= form_error('url');?>
                      </div>
                    </div>
                    ...
                    <div class="form-group row"> 
                    <div class='col'>
                     <?php echo anchor('MidiasControl/Dashboard', 'Voltar', array('class'=>'btn btn-primary')); ?>
                    </div>
                    <div class='col-6'></div>
                    <div class= 'col'>
