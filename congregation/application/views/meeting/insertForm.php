...
<div class="card card-info">
              ...
              <!-- form start -->
               ...
               <?php  endif ?> 
                <div class="card-body">
                  <?php echo form_open('MeetingControl/insert'); ?>
                
                    <div class="form-group row">
                      <label for="inputPassword3" class="col-sm-2 col-form-label">NOME</label>
                      <div class="col-sm-10">
                        <input class='form-control' name='nome'   placeholder='Informe o nome da reunião'/>  
                        <?= form_error('nome');?>
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input class='form-control' name='descricao'   placeholder='Informe uma descrição da Reunião'/>  
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input class='form-control' name='endereco'   placeholder='Informe o endereço'/>  
                        <?= form_error('endereco');?>
                      </div>
                    </div>   
                      ...
                      <div class="col-sm-10">
                        <input class='form-control' name='complemento'   placeholder='Informe o complemento do endereço'/>  
                       </div>
                    </div>   
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-3">
                      <input class='form-control' name='cep'  type='text' placeholder='Informe um CEP' />                 
                         
                      </div>
                      &nbsp&nbsp&nbsp <label for="inputPassword3" class="col-sm-2 col-form-label">TEL</label>
                      <div class="col-sm-3">
                        <input class='form-control' name='telefone'  type='number'placeholder='Informe um telefone' />  
