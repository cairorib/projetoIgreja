    ...
    <section class="content">
      <div class="row">
            ...
            <div class="card-header">
              ...
              <?= anchor('DonateControl/insertForm','Adicionar Conta', array('class'=>'btn btn-primary') );?>
            </div>
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td><?= $dado['id']?></td>
                  <td><b><?= $dado['banco']?></b></td>
                  <td><i><?= $dado['conta']?></i></td>
                  <td><?= $dado['tipo']?></td>
                  <td><?= $dado['agencia']?></td>
                  <td><b><?= $dado['iban']?></b></td>
                  <td><i><?= $dado['swift']?></i></td>
                   <td>
                  <?php 
                      /* update */
                      echo form_open('DonateControl/updateForm');
                      ...
                      echo form_close(); 
                            ?><?php
                      /* delete */
                      echo form_open('DonateControl/deleteForm'); 
                      echo form_hidden('dados',$dado);
                      echo form_button(array(
