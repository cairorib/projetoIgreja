    ...
    <section class="content">
      <div class="row">
            ...
            <div class="card-header">
              ...
              <?= anchor('testimonyControl/testimonyForm','Adicionar Testemunho ', array('class'=>'btn btn-primary') );?>
            </div>
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php 
                      /* update */
                      echo form_open('testimonyControl/testimonyoUpdt');
                      ...
                      echo form_close(); 
                            ?><?php
                      /* delete */
                      echo form_open('testimonyControl/testimonyDlt'); 
                      echo form_hidden('dados',$dado);
                      echo form_button(array(
                        'data-toggle'=>'modal',
                        'data-target'=>'#myModal',
