...
<div class="card card-info">
               <div class="card-header">
                <h3 class="card-title">delete form Presentation</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
               
                <div class="card-body">
                  <?php echo form_open('PresentationControl/delete');
                  ...
                  <center>ATENÇÂO: </br><b> AS SEGUINTES INFORMAÇÕES SERÃO EXCLUÍDAS</b></center>
                    ...
                    <div class="form-group row"> 
                    <div class='col'>
                     <?php echo anchor('PresentationControl/Dashboard', 'Voltar', array('class'=>'btn btn-primary')); ?>
                    </div>
                    <div class='col-6'></div>
                    <div class= 'col'>
