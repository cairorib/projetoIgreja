    ...
    <section class="content">
      <div class="row">
            ...
            <div class="card-header">
              ...
              <?= anchor('AvisoControl/insertForm','Adicionar Aviso', array('class'=>'btn btn-primary') );?>
            </div>
            ...
            <div class="card-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php 
                      /* update */
                      echo form_open('AvisoControl/updateForm');
                      ...
                      echo form_close(); 
                            ?><?php
                      /* delete */
                      echo form_open('AvisoControl/deleteForm'); 
                      echo form_hidden('dados',$dado);
                      echo form_button(array(
